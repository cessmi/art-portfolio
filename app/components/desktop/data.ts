...
> = {
  ...
  "lament-of-departed": {
    title: "Lament of Departed",
    items: [
      {
        id: "lament-title-screen",
        label: "Title Screen.png",
        kind: "file",
        documentId: "lament-title-screen",
      },
      {
        id: "lament-gameplay-map",
        label: "Gameplay Map.png",
        kind: "file",
        documentId: "lament-gameplay-map",
      },
      {
        id: "lament-phoibus-dialogue",
        label: "Phoibus Dialogue.png",
        kind: "file",
        documentId: "lament-phoibus-dialogue",
      },
      {
        id: "lament-daphni-dialogue",
        label: "Daphni Dialogue.png",
        kind: "file",
        documentId: "lament-daphni-dialogue",
      },
      {
        id: "lament-interior-map",
        label: "Interior Map.png",
        kind: "file",
        documentId: "lament-interior-map",
      },
      {
        id: "lament-github",
        label: "GitHub Repository",
        kind: "folder",
        href: "https://github.com/cessmi/Lament-of-the-Departed.git",
      },
      {
        id: "lament-txt",
        label: "Lament of Departed.txt",
        kind: "file",
        documentId: "lament-txt",
      },
    ],
  },
  "case-studies": {
    ...
    items: [
      {
        id: "case-study-welllife",
        label: "WellLife CaseStudy.jpg",
        kind: "file",
        documentId: "welllife-case-study",
      },
      {
        id: "case-study-welllife-figma",
        label: "WellLife Case Study Figma",
        kind: "folder",
      ...
      {
        id: "case-study-zapac-figma",
        label: "ZAPAC Case Study Figma",
        kind: "folder",
...
export const shortcutDocuments: Record<string, ShortcutDocument> = {
  ...
  "lament-title-screen": {
    ...
    kind: "image",
    imageSrc: "/images/shortcut/lament-of-departed/title-screen.png",
    imageAlt: "Lament of the Departed title screen",
  },
  "lament-gameplay-map": {
    id: "lament-gameplay-map",
    title: "Gameplay Map.png",
    kind: "image",
    imageSrc: "/images/shortcut/lament-of-departed/gameplay-map.png",
    imageAlt: "Lament of the Departed gameplay map",
  },
  "lament-phoibus-dialogue": {
    id: "lament-phoibus-dialogue",
    title: "Phoibus Dialogue.png",
    kind: "image",
    imageSrc: "/images/shortcut/lament-of-departed/phoibus-dialogue.png",
    imageAlt: "Phoibus dialogue scene in Lament of the Departed",
  },
  "lament-daphni-dialogue": {
    id: "lament-daphni-dialogue",
    title: "Daphni Dialogue.png",
    kind: "image",
    imageSrc: "/images/shortcut/lament-of-departed/daphni-dialogue.png",
    imageAlt: "Daphni dialogue scene in Lament of the Departed",
  },
  "lament-interior-map": {
    id: "lament-interior-map",
    title: "Interior Map.png",
    kind: "image",
    imageSrc: "/images/shortcut/lament-of-departed/interior-map.png",
    imageAlt: "Interior map scene in Lament of the Departed",
  },
  "lament-txt": {
    id: "lament-txt",
    title: "Lament of Departed.txt",
    kind: "text",
    content:
      "✨ About the Game\nLament of the Departed follows the mysterious journey of a lone character navigating a broken world filled with haunting echoes of the past. Through pixel-crafted maps and emotionally-driven dialogues, players uncover a tale of loss, memory, and choice.\n\nThis is Part 1 of a two-part narrative.\nPart 2 will be continued by Zoie Estorba.\n\n👩‍💻 Developed By\n🎮 Princess Mikaela Borbajo — Programming, Game Design, Art, and Story (Part 1)\n🌠 Zoie Estorba — Lead Developer and Artist (Part 2)\nWe worked side by side to bring Nikke Mirai to life as an original narrative universe.\n\n✨ Features\n✅ Java-based custom game engine\n✅ 2D pixel movement and character control\n✅ Interactive NPCs and dialogues\n✅ Scene/map switching\n✅ Hand-drawn character sprites and environments\n✅ Basic mission and story structure\n\n🖥️ Technologies Used\nJava (JDK 17+)\nJava Swing / AWT for rendering\nBufferedImage, Graphics2D, and custom timers\nObject-Oriented Design for character, UI, and system logic\n\n🗂️ Project Structure\nThe project is organized around Java source files, hand-drawn sprites, maps, UI screens, and story/dialogue systems for the custom game engine.",
  },
